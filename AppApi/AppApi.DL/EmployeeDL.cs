...
namespace AppApi.DL
{
    public class EmployeeDL : DBConnect
    {
        ...
        public bool RegisterDL(User input)
        {
            ...
            string SQL = @"dbo.[sp_Employee_Create]";
            ...
            //string SQL = string.Format("EXEC [dbo].[sp_Employee_Create] @FullName @Code @Cmnd @Tel @Email @UserName @Password 2 @Image @IsDeleted @Address");
       ...
       public bool UpdateDL(User input)
        {
            _conn.Open();
            string SQL = @"dbo.[sp_Employee_Update]";
        ...
        public bool DeleteDL(User input)
        {
            ...
            string SQL = @"dbo.[sp_Employee_Delete]";
        ...
        public List<Role> GetRole(GetEmployeeInput input)
        {
            _conn.Open();

            string spName = @"dbo.[GetRole]";
            SqlCommand cmd = new SqlCommand(spName, _conn);
